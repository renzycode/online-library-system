    ...
    if(isset($_GET['add'])){
        ...
        if($_GET['add']=='error'){
            if($_GET['error']=='rfidexisting'){
                ...
                echo '
                <div class="alert alert-danger">
                    Error Add, Duplicate Author ID.
                </div>
                ';
            }elseif($_GET['error']=='authoridnotfound'){
                echo '
                <div class="alert alert-danger">
                    Error Add, There was an Author ID couldn\'t found.
                </div>
                ';
            }else{
                echo '
                ...
                ';
                    ...
                    foreach ($catalogs as $catalog){
                        ...
                        <tr>
                            ...
                            <td class="border-tr"><a class="btn btn-success" href="add_book_copy.php?book_id='.$catalog['book_id'].'"> Clone Book </a></td>
