...
--
-- Host: 127.0.0.1
-- Generation Time: Mar 28, 2023 at 03:19 PM
...
CREATE TABLE `transaction_table` (
  ...
  `book_id_4` int(11) NOT NULL,
  `book_id_5` int(11) NOT NULL,
  `borrower_id` int(11) NOT NULL,
...
INSERT INTO `transaction_table` (`transaction_id`, `librarian_id`, `book_id_1`, `book_id_2`, `book_id_3`, `book_id_4`, `book_id_5`, `borrower_id`, `transaction_borrow_datetime`, `transaction_return_datetime`, `transaction_status`) VALUES
(34, 1, 5, 1, 0, 0, 0, 8, '2023-03-27|01:39', '2023-03-27|01:39', 'Returned'),
(35, 1, 5, 1, 0, 0, 0, 8, '2023-03-27|01:42', '2023-03-27|01:42', 'Returned');
...
--
ALTER TABLE `borrower_table`
  MODIFY `borrower_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=23;
