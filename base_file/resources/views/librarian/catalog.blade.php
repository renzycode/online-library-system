...
<div class="m-4">
    ...
    <div class="modal fade" id="modalAdd" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
        <div class="modal-dialog">
            <div class="modal-content">
                <form action="{{ route('add.catalog') }}" method="post">
                    @csrf
    ...
    @if ( count($catalogs)<=0 ) <div class="alert alert-warning">
    ...
    <table class="table table-bordered border-secondary">
        ...
        <tbody>
            ...
            <tr>
                ...
                <td>{!!$data['catalog_book_title']!!}</td>
                <td>{!!$data['catalog_author']!!}</td>
                <td>{!!$data['catalog_publisher']!!}</td>
                <td>{!!$data['catalog_year']!!}</td>
                <td>{!!$data['catalog_date_received']!!}</td>
                <td>{!!$data['catalog_class']!!}</td>
                <td>{!!$data['catalog_edition']!!}</td>
                <td>{!!$data['catalog_volumes']!!}</td>
                <td>{!!$data['catalog_pages']!!}</td>
                <td>{!!$data['catalog_source_of_fund']!!}</td>
                <td>{!!$data['catalog_cost_price']!!}</td>
                <td>{!!$data['catalog_location_symbol']!!}</td>
                <td>{!!$data['catalog_class_number']!!}</td>
                <td>{!!$data['catalog_author_number']!!}</td>
                <td>{!!$data['catalog_copyright_date']!!}</td>
                ...
                <td>
                    ...
                    <div class="modal fade" id="modalEdit{!!$number!!}" tabindex="-1"
                        ...
                        <div class="modal-dialog">
                            <div class="modal-content">
                                <form action="{{ route('edit.catalog') }}" method="post">
                                    @csrf
                                    <div class="modal-header">
                                    ...
                                    <div class="modal-body row">
                                        ...
                                        <div class="form-group col-6">
                                            ...
                                            <input type="text" name="catalog_number"
                                                class="form-control border-dark border" value="{!!$data['catalog_number']!!}" required/>
                                        </div>
                                        <div class="form-group col-6">
                                            <label class="col-form-label">Book Title
                                                <span class="text-danger">*</span>
                                            ...
                                            <input type="text" name="catalog_book_title"
                                                class="form-control border-dark border" value="{!!$data['catalog_book_title']!!}" required/>
                                        </div>
                                        <div class="form-group col-6">
                                            <label class="col-form-label">Author
                                                <span class="text-danger">*</span>
                                            ...
                                            <input type="text" name="catalog_author"
                                                class="form-control border-dark border" value="{!!$data['catalog_author']!!}" required/>
                                        </div>
                                        <div class="form-group col-6">
                                            <label class="col-form-label">Publisher
                                                <span class="text-danger">*</span>
                                            ...
                                            <input type="text" name="catalog_publisher"
                                                class="form-control border-dark border" value="{!!$data['catalog_publisher']!!}" required/>
                                        </div>
                                        <div class="form-group col-6">
                                            <label class="col-form-label">Year
                                                <span class="text-danger">*</span>
                                            ...
                                            <input type="text" name="catalog_year"
                                                class="form-control border-dark border" value="{!!$data['catalog_year']!!}" required/>
                                        </div>
                                        <div class="form-group col-6">
                                            <label class="col-form-label">Date Received</label>
                                        ...
                                        <div class="form-group col-6">
                                            <label class="col-form-label">Status</label>
                                            @if($data['catalog_status'] == "available")
                                            <select class="form-select" aria-label="" name="catalog_status">
                                                <option selected value="available">Available</option>
                                                <option value="unavailable">Unavailable</option>
                                            </select>
